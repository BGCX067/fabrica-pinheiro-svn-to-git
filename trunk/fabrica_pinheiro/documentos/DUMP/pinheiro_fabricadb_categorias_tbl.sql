...
--
-- Table structure for table `categorias_tbl`
--

DROP TABLE IF EXISTS `categorias_tbl`;
...
--
-- Dumping data for table `categorias_tbl`
--

LOCK TABLES `categorias_tbl` WRITE;
/*!40000 ALTER TABLE `categorias_tbl` DISABLE KEYS */;
/*!40000 ALTER TABLE `categorias_tbl` ENABLE KEYS */;
UNLOCK TABLES;
