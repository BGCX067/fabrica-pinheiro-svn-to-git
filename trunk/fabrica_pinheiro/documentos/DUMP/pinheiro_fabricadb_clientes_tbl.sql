...
CREATE TABLE `clientes_tbl` (
  ...
  KEY `fk_clientes_tbl_pessoas_tbl` (`id_pessoas`),
  CONSTRAINT `fk_clientes_tbl_pessoas_tbl` FOREIGN KEY (`id_pessoas`) REFERENCES `pessoas_tbl` (`id_pessoas`) ON DELETE NO ACTION ON UPDATE NO ACTION
